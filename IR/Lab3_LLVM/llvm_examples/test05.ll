...
; <label>:2                                       ; preds = %5, %0
  %3 = load i32* %count, align 4, !dbg !14
  %4 = icmp slt i32 %3, 100, !dbg !14
  br i1 %4, label %5, label %8, !dbg !14

; <label>:5                                       ; preds = %2
  %6 = load i32* %count, align 4, !dbg !15
  %7 = add nsw i32 %6, 1, !dbg !15
  store i32 %7, i32* %count, align 4, !dbg !15
  br label %2, !dbg !17

; <label>:8                                       ; preds = %2
  %9 = load i32* %count, align 4, !dbg !18
  %10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0), i32 %9), !dbg !18
  ret i32 0, !dbg !19
}
...
!16 = metadata !{i32 786443, metadata !1, metadata !4, i32 11, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/zhiwei/project/Course_Compiler_Design/IR/Lab3_LLVM/llvm_examples/test05.c]
!17 = metadata !{i32 13, i32 0, metadata !16, null}
!18 = metadata !{i32 15, i32 0, metadata !4, null}
!19 = metadata !{i32 17, i32 0, metadata !4, null}
