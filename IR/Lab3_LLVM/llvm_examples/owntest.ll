...
define i32 @main() #0 {
  ...
  call void @llvm.dbg.declare(metadata !{float* %j}, metadata !14), !dbg !16
  %2 = load i32* %i, align 4, !dbg !17
  %3 = load float* %j, align 4, !dbg !17
...
!14 = metadata !{i32 786688, metadata !4, metadata !"j", metadata !5, i32 5, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ] [j] [line 5]
